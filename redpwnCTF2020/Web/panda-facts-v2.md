...
2. In this one now we dont have to previous vuln of Json injeciton.

3. So this is actual crypto bit flipping chall now.

4. the use of an "integrity" string rather than a HMAC for authentication suggests we could use a CBC bitflip attack.

5. https://github.com/hyperreality/ctf-writeups/tree/master/2020-redpwn
